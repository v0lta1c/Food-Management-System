...
function toSubmit(e){
		...
		//	{
		//?>		
		//		var valid = (document.getElementById('hidden_RID').value == <?php echo $_SESSION["cart"][0]["R_ID"] ?>);
		//		if(!valid)
		//		{
		//			alert("Cannot order from a different restaurant);
		//			return false
		//		}
		//		alert('he;;p');
		//		return true;
...
<form method="post" onsubmit="if(<?php echo $_SESSION["cart"][0]["R_ID"] ?> != <?php echo $row["R_ID"]; ?>) { alert('Cannot order food items from multiple restaurants!'); return false; }" action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
